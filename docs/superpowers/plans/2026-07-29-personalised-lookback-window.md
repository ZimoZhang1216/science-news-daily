...
- [x] **Step 1: Write failing boundary and migration tests**
...
- [x] **Step 3: Add the validated field and migration**
...
- [x] **Step 3: Replace the personalised environment lookup**
...
- [x] **Step 1: Write failing UI and recommendation tests**
...
- [x] **Step 3: Render and persist the control**
...
- [x] **Step 1: Document the per-user 1–60 day window**
